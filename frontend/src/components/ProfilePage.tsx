...
const ProfilePage: React.FC = () => {
  ...
  const profileImageUrl = imagePreview || (() => {
    ...
    return `${import.meta.env.VITE_API_URL || ''}${profile.profilePic}`;
  })();
          ...
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            {selectedPost.images && selectedPost.images.length > 0 && (
              <div className={styles.modalImages}>
                ...
                <img
                  src={`${import.meta.env.VITE_API_URL || ''}${selectedPost.images[activeImageIndex]}`}
                  alt={selectedPost.title}
                  className={styles.modalImage}
                  onClick={() =>
                    setFullImageUrl(`${import.meta.env.VITE_API_URL || ''}${selectedPost.images[activeImageIndex]}`)
                  }
                />
                <button
                  className={styles.carouselButton}
